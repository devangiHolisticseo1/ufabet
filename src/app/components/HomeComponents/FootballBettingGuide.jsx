            ...
            >
              <div className="accordion-body">
                <ol>
                  ...
                  <li>
                    <strong className="golden-text">Register and Verify Account</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Deposit Funds</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Select Football Section</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Pick a league or a match</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Compare Odds and Markets</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Enter Stake Amount</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Confirm Bet Slip</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Track Match and Outcome</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Withdraw Winnings</strong>
                    <p>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                <ol>
                  <li>
                    <strong className="golden-text">Review recent form</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Compare home vs. away records</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Analyze head-to-head history</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Check squad news and injuries</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Evaluate motivation and stakes</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Assess offensive and defensive stats</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Study tactical style and matchups</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Use in-platform tools and insights</strong>
                    <p>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                <ol>
                  <li>
                    <strong className="golden-text">Analyze match data and team statistics</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Convert probabilities into Odds Formats</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Adjust for market behavior and cash flow</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Include profit margin (overround)</strong>
                    <p>
                  ...
                  <li>
                    <strong className="golden-text">Update odds in real time</strong>
                    <p>
