...
import GradientCollapseForSlider from "./GradientCollapseForSlider";
...
const tabsData = [
    ...
    items: [
      {
        ...
        description: "Deposits are processed instantly.",
      },
  ...
  },
  {
    ...
    items: [
      {
        title: "Welcome Bonus",
        description: "Get 100% on first deposit.",
        innerItem: [
          {
            title: "Live Betting",
            description: "Bet on games as they happen.",
          },
          { title: "Cash Out", description: "Take control of your bets." },
        ],
      },
    ],
  },
    ...
    <section className="container tabs-swiper-container mb-5">
      ...
      >
        <div className="tab-content-inner">
          <GradientCollapseForSlider 
            dataSource={tabsData[activeIndex].items} 
