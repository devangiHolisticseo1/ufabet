            ...
            <div className="accordion" role="tablist">
              ...
              <section className="accordion-item bg-transparent border-bottom">
                <h3 className="accordion-header" id="heading-main">
                  {/* <button
                    className={`accordion-button d-flex justify-content-between align-items-center ${openFAQ === 'main' ? '' : 'collapsed'} bg-transparent text-white`}
                    type="button"
                    onClick={() => toggleFAQ('main')}
              ...
              {activeTopic.content.faqs.map((faq, index) => (
                <section key={index} className="accordion-item bg-transparent border-bottom">
                  <h3 className="accordion-header" id={`heading-${index}`}>
                    {/* <button
                      className={`accordion-button d-flex justify-content-between align-items-center ${openFAQ === index ? '' : 'collapsed'} bg-transparent text-white`}
                      type="button"
                      onClick={() => toggleFAQ(index)}
