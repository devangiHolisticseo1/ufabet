    ...
    <section className="home_sec6_p1">
      <header className="text-center mb-4">
        ...
        <p className="home_sec6_p1_p">
          Your ultimate guide to football betting with trusted strategies and insights.
        </p>
      </header>

      <Container   className="home_sec6_p1_container">
        <Row>
          {/* Sidebar */}
          <aside className="col-md-3 home_sec6_p1_sidebar">
              ...
              <ListGroup variant="flush">
                {categories.map((item, idx) => (
                  <ListGroup.Item
                    key={idx}
                    action
                    className={`home_sec6_p1_menu_item ${
          ...
          {/* Main Content */}
          <article className="col-md-9 home_sec6_p1_main">
            <header>
              <h3 className="home_sec6_p1_heading"> แทงบอล for {selected.title}</h3>
            <hr className="home_sec6_p2_heading_bottom_line"></hr>
            </header>

            {selected.description1 && <p className="home_sec6_p1_description">{selected.description1}</p>}
            {selected.description2 && <p className="home_sec6_p1_description">{selected.description2}</p>}
            ...
            {selected.description3 && <p className="home_sec6_p1_description">{selected.description3}</p>}
          </article>
        </Row>
      </Container>
    </section>
