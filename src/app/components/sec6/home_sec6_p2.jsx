...
// import "./home_sec6_p2.css"; // ✅ UPDATED FILE NAME
...
//             <h2 className="home_sec6_p2_title">แทงบอล for Goals, Assists and Scores</h2>
//             <p className="home_sec6_p2_p">When betting on football, you are not limited to match outcomes (win/lose/draw). Many betting markets focus on player and match statistics, including:</p>

//             <Container fluid className="home_sec6_p2_container">
//                 <Row>
//                     {/* Sidebar */}
//                     <Col md={3} className="home_sec6_p2_sidebar">
...
//                                     key={idx}
//                                     action
//                                     className={`home_sec6_p2_menu_item ${item.key === selected.key ? "active" : ""} d-flex justify-content-between align-items-center`}
...
//                     {/* Main Content */}
//                     <Col md={9} className="home_sec6_p2_main">
//                         <h3 className="home_sec6_p2_heading">แทงบอล for {selected.title}</h3>

//                         {selected.description1 && (
//                             <p className="home_sec6_p2_description">{selected.description1}</p>
//                         )}
//                         {selected.description2 && (
//                             <p className="home_sec6_p2_description">{selected.description2}</p>
//                         )}

//                         <Card className="home_sec6_p2_card">
//                             <Card.Body>
//                                 <Card.Title className="home_sec6_p2_card_title">In Betting (แทงบอล – Goals Market)</Card.Title>
...
//                             <p className="home_sec6_p2_description">{selected.description3}</p>
//                         )}
//                     </Col>
//                 </Row>
//             </Container>
