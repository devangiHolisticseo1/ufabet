    ...
    <div className="container  home_sec9_container">
      ...
      <div className="row">
        ...
        <div className="col-md-3 home_sec9_sidebar">
          {/* <div className="home_sec9_sidebar_header">
            <h6 className="home_sec9_sidebar_title">breakdown of common betting types</h6>
          </div> */}
          ...
          <div className="home_sec9_content_wrapper">
            ...
            <div className="home_sec9_content_body">
              ...
              {currentContent.types && (
                <div className="home_sec9_types_section">
                  <h5 className="home_sec9_section_title">Types of {selectedBetting.split('(')[0].trim()}</h5>
                  <p className="home_sec9_types_intro">
                    {selectedBetting.includes('Handicap') 
                      ...
                      : 'Different variations of this betting type:'
                    }
                  </p>
                  
                  <div className="home_sec9_types_list">
                    {currentContent.types.map((type, index) => (
                      <div key={index} className="home_sec9_type_item">
                        <h6 className="home_sec9_type_name">{type.name}:</h6>
              ...
              {currentContent.when && (
                <div className="home_sec9_when_section">
                  <h5 className="home_sec9_section_title">When to Use {selectedBetting.split('(')[0].trim()}</h5>
